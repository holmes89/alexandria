...
var $author$project$Main$GotBook = function (a) {
	return {$: 'GotBook', a: a};
};
...
var $author$project$Main$Book = F2(
...
var $author$project$Main$getBook = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotBook, $author$project$Main$listBookDecoder),
		url: 'https://alexandria-api-4josd7vm2q-ue.a.run.app/documents/'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$Loading, $author$project$Main$getBook);
};
...
var $author$project$Main$viewBooks = function (model) {
	switch (model.$) {
		case 'Failure':
			return A2(
				$elm$html$Html$div,
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$class('is-one-quarter')
								]),
							_List_fromArray(
								[
									A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text(l.displayName)
														]))
												])),
											A2(
											$elm$html$Html$div,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('http://read.jholmestech.com/assets/covers/' + (l.id + '.jpg')),
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('is-light')
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Alexandria'),
												A2(
												$elm$html$Html$img,
												_List_fromArray(
													[
														$elm$html$Html$Attributes$src('/assets/alexandria.png')
													]),
												_List_Nil)
											]))
									]))
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$viewBooks(model)
									]))
							]))
					]))
			]));
